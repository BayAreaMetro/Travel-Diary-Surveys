...
trip_facility_loc <- "E:/Box/Modeling and Surveys/Surveys/Travel Diary Survey/BATS_2023/Analysis/BATS_2019vs2023"                           
#Output <- file.path(Box_TM2,"Facility Summaries")
output_loc    <- file.path("E:/Box/Modeling and Surveys/Surveys/Travel Diary Survey/BATS_2023/Analysis/BATS_2019vs2023","Facility Summaries")
...
freeway_coords_in <- file.path(Box_TM2, "Facility Summaries","Freeway Facility Coordinates.csv")
...
# this file is generated by Join OSM and TNC Survey Paths Files and Create Facility Flags.R 
facility_flag <- read.csv(file = file.path(trip_facility_loc,"TNC Survey Trips Per Facility.csv"))

full_facilities_list <- c("Al_SF_80_PlazaTo101", "Al_SF_80_BayBridge","SF_101_80ToSM", 
...
# write this to cwd
# originally, it was written to: M:\Data\HomeInterview\Bay Area Travel Study 2018-2019\Data\MOE Testing
...
write.csv(final2,file.path(output_loc,"BATS_2019_Facility_Daypart_Summary.csv"),row.names = FALSE)
...
write.csv(final3,file.path(output_loc,"BATS_2019_Facility_Daypart_Summary_AMI_in_Rows.csv"),row.names = FALSE)
write.csv(final4,file.path(output_loc,"BATS_2019_Facility_Daypart_Summary_Race_in_Rows.csv"),row.names = FALSE)
