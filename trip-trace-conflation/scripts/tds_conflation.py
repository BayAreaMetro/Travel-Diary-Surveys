...
if __name__ == "__main__":
    ...
    parser.add_argument("--test", help="Run in test mode: output locally instead of to box", action="store_true")
    args = parser.parse_args()

    main(location_path=config.location_path, trip_path=config.trip_path, 
